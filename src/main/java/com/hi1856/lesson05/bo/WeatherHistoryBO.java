package com.hi1856.lesson05.bo;
...
import com.hi1856.lesson05.dao.WeatherHistoryDAO;
import com.hi1856.lesson05.model.WeatherHistory;
	...
	public void addWeatherHistory(String date, String weather,String microDust,
		...
		weatherHistoryDAO.selectWeatherHistory(date, weather, microDust, temperatures, precipitation, windSpeed);
	}
}
